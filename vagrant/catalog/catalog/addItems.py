...
cats.append(cat1)
item1 = Item(name="Ball", description="The ball",image=None, category=cat1, user=user1)
item2 = Item(name="Basket", description="The target basket", image=None, category=cat1, user=user1)

cat2 = Category(name="Skating", user=user1)
cats.append(cat2)
item3 = Item(name="Skateboard", description="Skateboard", image=None, category=cat2, user=user1)
...
# create directories for each category, s